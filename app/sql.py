...
def sql_chain(question):
    ...
    if response is None:
        return "Sorry , there was problem executing this SQL query"
...
if __name__ == "__main__":
    ...
    # df = run_query(query)
    # pass
    # question = "All NIke shoes in price range of 5000 to 10000"
    question = "Give me puma shoes with rating higher than 4.5 and discount more than 30 percent"
